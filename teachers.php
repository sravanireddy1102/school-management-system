    ...
    mysqli_close($dbc);
        ...
        <form method = "post" action = "<?php echo "/teachers.php?userid=$userid" ?>"> 
            <div class="student-box">
                <h4>Enter the TeacherId</h4>
                <div class="notif">
                    <lable><?php echo "$notif" ?></lable><br />
                </div>
                <div class="textbox">
                    <input type="text" placeholder="TeacherId" spellcheck="false" name="teacherid" value="<?php echo $teacher_id ?>">
                </div>
        ...
        <!--<form method = "post" action = "<?php echo $_SERVER['PHP_SELF']; ?>"> 
            ...
            if(isset($_POST['submit'])){
                ...
                <label><?php echo 'Phone number: '.$phone ?></label><br />
                <label><?php echo 'Email: '.$email ?></label><br />
                <label><?php echo 'Sex: ' .$sex ?></label><br />
                <label><?php echo 'DOB: ' .$dob ?></label><br />
                <label><?php echo 'Hiredate: ' .$hiredate ?></label><br />
                <label><?php echo 'Address: ' .$address ?></label><br />
                <label><?php echo 'Salary: ' .$salary ?></label><br />
                <?php
            }
            ?>
