    ...
    mysqli_close($dbc);
        ...
        <form method = "post" action = "<?php echo "/subjects.php?userid=$userid" ?>"> 
            <div class="student-box">
                <h4>Enter the SubjectId</h4>
                <div class="notif">
                    <lable><?php echo "$notif" ?></lable><br />
                </div>
                <!--<div class="input-group" class="textbox">
                <input type="text" class="form-control rounded" placeholder="Student ID" aria-label="Search"
                    aria-describedby="search-addon" value="<?php echo $student_id ?>" />
                <input type="submit" name="submit" value="Sign in" class="btn btn-outline-primary">
                </div>-->
                <div class="textbox">
                <!--<i class="fas fa-user"></i>-->
                    <input type="text" placeholder="SubjectId" spellcheck="false" name="subjectid" value="<?php echo $subject_id ?>">
                </div>
        ...
        <!--<form method = "post" action = "<?php echo $_SERVER['PHP_SELF']; ?>"> 
            ...
            if(isset($_POST['submit'])){
                ...
                <label><?php echo 'teacherid number: ' .$teacherid ?></label><br />
                <label><?php echo 'classid: ' . $classid ?></label><br />
                <?php
            }
            ?>
